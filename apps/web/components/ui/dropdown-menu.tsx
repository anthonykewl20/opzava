  ...
  return (
    <DropdownMenuPortal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-[var(--z-modal)] min-w-44 overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-md outline-none data-[state=closed]:animate-none data-[state=open]:animate-none",
          className,
        )}
        {...props}
      />
