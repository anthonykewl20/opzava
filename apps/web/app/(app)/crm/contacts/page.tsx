      ...
      <div className="page-stack">
        <div className="page-header">
          ...
          <details className="issues-new-menu">
            ...
            <form className="issues-new-form" action={createContactAction}>
              ...
              <table className="table table-cards">
                ...
                <tbody>
                  {contacts.map((contact) => (
                    <tr key={contact.id}>
                      <td data-label="Name">
                        <a className="issues-title-link" href={`/crm/contacts/${contact.id}`}>
                          {contact.displayName}
                        </a>
                        <p className="u-subtle">{ownerLabel(contact.ownerUserId, context)}</p>
                      </td>
                      <td data-label="Title">
