---
name: opzava
description: "Interact with Opzava — AI agent orchestration dashboard. Use when registering agents, managing tasks, syncing skills, or querying agent/task status via Opzava APIs."
---

# Opzava Agent Skill

Opzava is an AI agent orchestration dashboard with real-time SSE/WebSocket, a skill registry, framework adapters, and RBAC. This skill teaches agents how to interact with Opzava APIs programmatically.
...
Opzava supports two auth methods:
...
Opzava broadcasts events via SSE (`/api/events`) and WebSocket. Key event types:
