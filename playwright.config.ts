...
export default defineConfig({
  testDir: 'tests',
  testIgnore: /openclaw-harness\.spec\.ts|\.visual\.spec\.ts$/,
  timeout: 60_000,
  expect: {
    timeout: 10_000
  },
  ...
  projects: [
    // channel: 'chrome' opts into the system-installed Google Chrome when bundled
    // chromium is unavailable (e.g. unsupported distros). Set E2E_USE_CHROME=1 to enable.
