 ...
 * popover. The rollup "🔗 5/7 connected" opens the all-tools OVERVIEW (rows drill
...
(function () {
  // The seven linked tools + their illustrative detail (matches essential-tools.html).
  var TOOLS = [
    ...
    { name: 'OpenClaw',       glyph: '＋', label: 'Not linked',   note: 'Not connected yet',            where: 'Run a fleet',      via: 'via Gateway',    caps: 'Orchestrate a fleet of agents',           ver: '',       seen: '',        needs: true  },
    { name: 'Hermes',         glyph: '✦', label: 'Active',       note: 'Fleet executing · 3 agents',   where: 'Run a fleet',      via: 'via Gateway',    caps: 'Run a fleet · parallel tasks',            ver: 'v3.1.0', seen: 'just now', needs: false }
  ];
