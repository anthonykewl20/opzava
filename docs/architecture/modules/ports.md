...
- **Adapters:** 3 adapters (real seam), one per bounded context: `RoleKeyCrmAuthorizationPort` (`packages/crm/src/application/authorization.ts:39`), `RoleKeyTaskAuthorizationPort` (`packages/project-management/src/application/authorization.ts:39`), `RoleKeyRuntimeControlAuthorizationPort` (`packages/runtime-control/src/application/authorization.ts:39`).
