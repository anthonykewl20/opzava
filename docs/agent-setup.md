...
This guide covers everything you need to configure agents in Opzava: registration methods, SOUL personalities, working files, configuration, and liveness monitoring.

## Agent Registration

There are three ways to register agents with Opzava.
...
You are Aegis, the quality gate for all agent work in Opzava.
...
Opzava tracks agent health through heartbeats.
