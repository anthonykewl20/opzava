...
This guide covers the task orchestration patterns available in Opzava, from simple manual assignment to fully automated multi-agent workflows.

## Task Lifecycle

Every task in Opzava follows this status flow:
