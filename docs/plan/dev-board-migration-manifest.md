...
GitHub mirror, classifications/roles, reversible archive + Historical Projection, legacy import, and active-membership gating are deferred to later TB-01 sub-slices / TB-GH1 (see follow-up #330).
