...
| Status | in-progress |
| Next concrete action | Slice 1d: app shell + admin navigation rendering the authenticated user and active org/workspace context (PRD-002). Wire the session-to-tenant resolution (getSession -> active org -> withTenant) into the shell. |
| Blockers | None |
