...
- Repository/release metadata points at the Opzava repository
...
- Stopped forcing `dangerouslyDisableDeviceAuth` when registering Opzava as a dashboard
