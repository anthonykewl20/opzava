...
- Provider/model table shows provider, auth methods, models, live status, and row actions for configured providers; connected rows expose Manage, eligible Set as main orchestrator, and Disconnect from the row-actions menu.
