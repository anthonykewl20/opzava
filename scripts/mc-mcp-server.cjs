#!/usr/bin/env node
/*
 Opzava MCP Server (stdio transport)
...
const TOOLS = [
  ...
  {
    name: 'mc_list_agents',
    description: 'List all agents registered in Opzava',
  ...
  {
    name: 'mc_list_tasks',
    description: 'List tasks in Opzava with optional filters',
    inputSchema: {
      type: 'object',
      properties: {
  ...
  {
    name: 'mc_health',
    description: 'Check Opzava health status (no auth required)',
    inputSchema: { type: 'object', properties: {}, required: [] },
    handler: async () => api('GET', '/api/status?action=health'),
  },
  {
    name: 'mc_dashboard',
    description: 'Get a dashboard summary of the entire Opzava system (agents, tasks, sessions, costs)',
    inputSchema: { type: 'object', properties: {}, required: [] },
  ...
  {
    name: 'mc_create_run',
    description: 'Report a new agent run to Opzava (agent-run protocol)',
    inputSchema: {
      type: 'object',
      properties: {
