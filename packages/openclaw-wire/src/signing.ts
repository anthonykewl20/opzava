...
export interface DeviceSignatureInput<Scope extends string = string> {
...
export interface DeviceKeypair<Scope extends string = string> {
  readonly deviceId: string
  readonly publicKey: string
  sign(input: DeviceSignatureInput<Scope>): Promise<string>
}
...
export class Ed25519DeviceKeypair<Scope extends string = string> implements DeviceKeypair<Scope> {
  ...
  public async sign(input: DeviceSignatureInput<Scope>): Promise<string> {
    return signData(
      null,
...
export class HmacDeviceKeypair<Scope extends string = string> implements DeviceKeypair<Scope> {
  public readonly deviceId: string
  public readonly publicKey: string
