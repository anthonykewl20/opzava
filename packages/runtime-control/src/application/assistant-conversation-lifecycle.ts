...
export function runtimeError(code: string, message: string, cause?: unknown): DomainError {
...
export function rowToToolOutcome(row: QueryRow): AssistantToolOutcome {
...
export const toolOutcomeSelect = sql`
  id,
  organization_id,
  workspace_id,
  turn_id,
...
export function validateCommonInput(
  input: RuntimeControlApplicationContext,
...
export async function selectTurnInScope(
  tx: TenantTransaction,
...
export function validateToolOutcomeReplay(
