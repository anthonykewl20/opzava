...
5. **Definition of Done:** deliverables complete · acceptance passes · `tdd` tests + lint + typecheck green (`verify-deep`) · local↔Dokploy parity intact · `docs/plan/EXECUTION.md` updated · committed via `commit-style` on a branch off `development`.
