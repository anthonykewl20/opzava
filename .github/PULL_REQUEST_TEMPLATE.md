...
- [ ] `tdd` tests added and passing · lint + typecheck green · `code-review` done.
...
- [ ] Branched off `development`; commits follow the repo commit conventions; no force-push to shared branches.
