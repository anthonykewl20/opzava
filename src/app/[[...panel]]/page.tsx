...
import { CampaignsPanel } from '@/components/panels/campaigns-panel'
import { OpsFailuresPanel } from '@/components/panels/ops-failures-panel'
import { OpsCostsPanel } from '@/components/panels/ops-costs-panel'
import { ApprovalQueuePanel } from '@/components/panels/approval-queue-panel'
import { ContentRunsPanel } from '@/components/panels/content-runs-panel'
import { ArtifactsPanel } from '@/components/panels/artifacts-panel'
import { TeamDashboardPanel } from '@/components/panels/team-dashboard-panel'
...
function ContentRouter({ tab }: { tab: string }) {
  ...
  switch (tab) {
    ...
    case 'failures':
      return <OpsFailuresPanel />
    case 'costs':
      return <OpsCostsPanel />
    case 'approval-queue':
      return <ApprovalQueuePanel />
    case 'content-runs':
      return <ContentRunsPanel />
    case 'artifacts':
      return <ArtifactsPanel />
    case 'team':
      return <TeamDashboardPanel />
    case 'maintenance':
