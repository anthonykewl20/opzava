...
import { SetupConnectionsStep } from '@/components/settings/setup-connections-step'

type SetupStep = 'form' | 'creating' | 'connections'
...
export default function SetupPage() {
  ...
  if (step === 'connections') {
    return <SetupConnectionsStep onFinish={() => { window.location.href = '/' }} />
  }
