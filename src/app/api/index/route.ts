...
const endpoints: Endpoint[] = [
  ...
  { path: '/api/releases/update', methods: ['POST'], description: 'Update Opzava to a specific release tag', tag: 'System', auth: 'admin' },
  { path: '/api/openclaw/version', methods: ['GET'], description: 'Docker sidecar OpenClaw version and latest release metadata', tag: 'System', auth: 'public' },
  { path: '/api/openclaw/update', methods: ['POST'], description: 'Return Docker sidecar OpenClaw update instructions', tag: 'System', auth: 'admin' },
  { path: '/api/openclaw/doctor', methods: ['GET', 'POST'], description: 'Inspect OpenClaw Docker sidecar health; local fixes are disabled', tag: 'System', auth: 'admin' },
