/**
 * Bidirectional mapping between Opzava statuses/priorities and GitHub labels.
...
const STATUS_LABEL_MAP: Record<TaskStatus, LabelDef> = {
  backlog:        { name: 'mc:backlog',        color: '94a3b8', description: 'Opzava: backlog' },
  inbox:          { name: 'mc:inbox',          color: '6b7280', description: 'Opzava: inbox' },
  assigned:       { name: 'mc:assigned',       color: '3b82f6', description: 'Opzava: assigned' },
  in_progress:    { name: 'mc:in-progress',    color: 'eab308', description: 'Opzava: in progress' },
  review:         { name: 'mc:review',         color: 'a855f7', description: 'Opzava: review' },
  quality_review: { name: 'mc:quality-review', color: '6366f1', description: 'Opzava: quality review' },
  done:           { name: 'mc:done',           color: '22c55e', description: 'Opzava: done' },
  awaiting_owner: { name: 'mc:awaiting-owner', color: 'f97316', description: 'Opzava: awaiting owner' },
  failed:         { name: 'mc:failed',          color: 'ef4444', description: 'Opzava: failed' },
}
