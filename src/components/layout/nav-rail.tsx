...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'failures', label: 'Failures', icon: <FailuresIcon />, priority: false },
      { id: 'costs', label: 'Costs', icon: <CostsIcon />, priority: false },
      { id: 'approval-queue', label: 'Approval Queue', icon: <ApprovalQueueIcon />, priority: false },
      { id: 'content-runs', label: 'Content Runs', icon: <ContentRunsIcon />, priority: false },
      { id: 'artifacts', label: 'Artifacts', icon: <ArtifactsIcon />, priority: false },
  ...
  },
  {
    ...
    label: 'AUTOMATE',
    items: [
      { id: 'campaigns', label: 'Campaigns', icon: <CampaignsIcon />, priority: false },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'maintenance', label: 'Maintenance', icon: <MaintenanceIcon />, priority: false },
      {
        ...
        <div className={`flex items-center shrink-0 ${sidebarExpanded ? 'px-3 py-3 gap-2.5' : 'flex-col py-3 gap-2'}`}>
          ...
          {sidebarExpanded && (
            <div className="flex items-baseline gap-2 truncate flex-1 min-w-0">
              <span className="text-sm font-semibold text-foreground truncate">Opzava</span>
...
function TeamIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M2 13c0-2 1.6-3.2 3.5-3.2S9 11 9 13" />
      <path d="M9.5 13c0-1.6 1-2.6 2.5-2.6S14 11.4 14 13" />
    </svg>
  )
}
...
function MaintenanceIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M10.5 2.5a3 3 0 0 0-3.8 3.8L2.6 10.4a1.3 1.3 0 0 0 1.8 1.8l4.1-4.1a3 3 0 0 0 3.8-3.8L10.4 6 9 4.6z" />
    </svg>
  )
}
...
function CostsIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M8 4.5v7" />
      <path d="M9.8 6c-.3-.7-1-1-1.8-1-1 0-1.7.5-1.7 1.3 0 1.9 3.6 1 3.6 2.9 0 .8-.8 1.3-1.9 1.3-.9 0-1.6-.4-1.9-1" />
    </svg>
  )
}
...
function CampaignsIcon() {
  return (
    <svg viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M2 6.5 13.5 2.5v9L2 9.5z" />
      <path d="M2 6.5v3" />
      <path d="M5 8.2v3.3c0 .6.4 1 1 1h1" />
    </svg>
  )
}
